...
metric_data.to_excel(writer, sheet_name='logit-regression-summary-stats', index=False)
...
complete_summary_stats_lg.to_excel(writer, sheet_name='logit-regression-pos-pred-data', index=False)
# close writer
writer.close()
